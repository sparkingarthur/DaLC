...
if __name__ == '__main__':
    ...
    dir_path = 'D:\\code\\data\\bulletvideo-affect\\20180401\\cutresults'
    expansion = 'flv'
    ...
    video_features.to_csv(path_or_buf='video_features204.csv')
    audio_features.to_csv(path_or_buf='audio_features204.csv')
