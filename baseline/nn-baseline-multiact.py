...
features = audiofeatures + videofeatures #+ #+ comment_fea
feanum = len(features)
...
for class_name in labels:
    ...
    model = buildmodel()
    bst_model_path = '../nnmodel/'+ class_name + 'nn.h5'
    ...
    result = model.predict(test_X,verbose=False)
...
sub.to_csv('nn-baseline-multiact-av.csv',index=False)
